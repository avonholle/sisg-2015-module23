...
* Calculate $\lamdba_{GC}$ for both phenotypes.
...
* \textrm{plink2 --bfile practical 3/data/QIMRX --pca 10 --out practical 3/results/QIMRX}


```{r}
system("plink2 --bfile practical_3/data/QIMRX --pca 10 --out practical_3/results/QIMRX", intern=T)
```


* Rerun the association analysis with these 10 PCs
  * \textrm{plink2 --bfile practical 3/data/QIMRX --maf 0.05 --geno 0.1 --mind 0.01 -hwe 0.001 --linear --covar practical 3/results/QIMRX.eigenvec --pheno practical 3/data/HT_T_X.pheno --mpheno 2 --out practical 3/results/QIMRX ST2}
...
* Calculate \lamdbda_{GC} for both phenotypes.

* You may find the following command useful to clump your results into ``roughly'' independent regions
  * \textrm{plink --bfile practical 3/data/QIMRX --clump QIMRX ST2.assoc.linear --clump-p1 0.5 --clump-p2 0.5 --clump-r2 0.20 --clump-kb 500 --out hgt gwas clump}
